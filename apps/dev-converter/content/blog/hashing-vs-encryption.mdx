...
- 🔐 **Generate SHA-256 / SHA-512 / MD5 hashes:** [Hash Generator →](/hash-generator)
- 🎫 **Inspect JWT token payload and claims:** [JWT Decoder →](/jwt-decoder)
- 🔑 **Generate secure random passwords:** [Password Generator →](/password-generator)
