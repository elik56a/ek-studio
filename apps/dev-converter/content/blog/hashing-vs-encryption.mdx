...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Passwords, checksums, integrity</td>
      <td>Secure storage, secrets, messaging</td>
    </tr>
    <tr>
      <td><strong>Examples</strong></td>
      <td>SHA-256, SHA-512, bcrypt</td>
      <td>AES, RSA</td>
    </tr>
  </tbody>
</table>
...
- 🔐 **Generate SHA-256 / SHA-512 / MD5 hashes:** [Free Hash Generator Tool for MD5, SHA-256, and SHA-512](/hash-generator)
- 🎫 **Inspect JWT token payload and claims:** [JWT Token Decoder and Inspector Tool](/jwt-decoder)
- 🔑 **Generate secure random passwords:** [Secure Password Generator Tool](/password-generator)
