...
export const metadata: Metadata = generateStaticPageMetadata({
  ...
  url: "/privacy",
  keywords: ["privacy policy", "data protection", "privacy", "devconverter"],
})

export default function PrivacyPage() {
  // Generate WebPage schema for Privacy Policy
  const pageSchema = generateStaticPageSchema({
    title: "Privacy Policy - DevConverter",
    description:
      "DevConverter Privacy Policy - Learn how we protect your data and respect your privacy.",
    url: "/privacy",
    keywords: ["privacy policy", "data protection", "privacy", "devconverter"],
            ...
            <Card className="glass border-0">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  ...
                  everything directly in your browser. This means your data
                  never leaves your device, never touches our servers, and is
                  never stored anywhere except your local machine.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass border-0">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    When you use any tool on DevConverter, all processing
                    happens using JavaScript in your browser. The data you input
                    is processed locally and displayed back to you instantly. No
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>
                    ...
                    To save your preferences for specific tools (like
                    indentation size)
                  </li>
                  <li>
                    <span className="font-semibold text-foreground">
                    ...
                    Optional local history of your recent conversions (stored
                    only on your device)
                  </li>
                </ul>
                <p className="leading-relaxed">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <ul className="space-y-3">
                  <li>
                    ...
                    Our website is hosted on Vercel. They may collect basic
                    server logs as part of their service.
                  </li>
                  <li>
                    <span className="font-semibold text-foreground">
                      Vercel Analytics:
