          ...
          <section id="popular" className="space-y-6 sm:space-y-8 px-4">
            <div className="text-center space-y-3 max-w-3xl mx-auto">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                DevConverter provides essential free online developer tools
                including a <strong>JSON formatter</strong> and validator,
                <strong> Base64 encoder/decoder</strong>,{" "}
                <strong>JWT decoder</strong>, and{" "}
                <strong>hash generator</strong> (MD5, SHA-1, SHA-256). All tools
                work offline and process data locally in your browser for
                maximum privacy.
              </p>
            </div>
          ...
          <section className="space-y-6 sm:space-y-8 px-4">
            <div className="container mx-auto max-w-6xl">
              <div className="text-center space-y-3 mb-8 max-w-3xl mx-auto">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  Whether you're debugging APIs, encoding data, or validating
                  tokens, our developer tools help you work faster. No
                  installation needed—just open your browser and start using
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      ...
                      never leaves your device. Perfect for handling sensitive
                      information like API keys and tokens.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      No server round trips means instant results. Our tools
                      handle large files and complex operations without breaking
                      a sweat.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Clean interfaces with keyboard shortcuts, syntax
                      highlighting, error validation, and smart formatting for
                      maximum efficiency.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Works offline once loaded. No account required, no
                      paywalls, no limits. Free forever with no hidden costs.
                    </p>
                  </CardHeader>
                </Card>
              </div>
          ...
          <section className="space-y-6 sm:space-y-8 px-4">
            <div className="container mx-auto max-w-4xl">
              <div className="text-center space-y-3 mb-8 max-w-3xl mx-auto">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  From API development to security tasks, DevConverter has the
                  tools you need for everyday coding challenges. Format JSON
                  responses, decode JWT tokens, encode credentials, and generate
                  hash signatures—all in one place.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Format JSON responses, decode JWT tokens, encode API
                      credentials in Base64, and generate hash signatures for
                      webhooks.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Convert between formats, encode/decode character sets,
                      generate checksums, and transform text for ETL pipelines.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Generate secure hashes (MD5, SHA-256, SHA-512), create
                      UUIDs, and validate cryptographic signatures client-side.
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="glass border-0">
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Compare code changes, beautify minified code, validate
                      syntax, and decode error messages for faster debugging.
                    </p>
                  </CardHeader>
                </Card>
              </div>
