      ...
      <div className="w-full space-y-16 pb-16">
        ...
        <div className="text-center space-y-6 sm:space-y-8 pt-8 sm:pt-16 pb-6 sm:pb-8 px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 pt-6 sm:pt-8 max-w-2xl mx-auto px-4">
            ...
            <div className="text-center">
              <div className="text-xl sm:text-2xl font-bold text-primary">10M+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-muted-foreground">Private</div>
            </div>
            <div className="text-center">
              <div className="text-xl sm:text-2xl font-bold text-primary">0ms</div>
              <div className="text-xs sm:text-sm text-muted-foreground">Server Delay</div>
            </div>
          </div>
        </div>
        ...
        <div id="popular" className="space-y-6 sm:space-y-8 px-4">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold">Most Popular Tools</h2>
            <p className="text-sm sm:text-base text-muted-foreground">The tools developers use every day</p>
          </div>
        ...
        <div id="categories" className="space-y-6 sm:space-y-8 px-4">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">Organized tools for every development need</p>
          </div>
        ...
        <div className="space-y-6 sm:space-y-8 px-4">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold">Why Choose Our Tools?</h2>
            <p className="text-sm sm:text-base text-muted-foreground">Built for developers, by developers</p>
          </div>
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              ...
              <Card className="glass border-0 text-center p-6 sm:p-8">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">100% Private</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
              ...
              <Card className="glass border-0 text-center p-6 sm:p-8 sm:col-span-2 md:col-span-1">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Developer First</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
