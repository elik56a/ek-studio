...
export default function TermsPage() {
  // Generate WebPage schema for the Terms page
  const pageSchema = generateStaticPageSchema({
    title: "Terms of Service - DevConverter",
    description:
      "DevConverter Terms of Service - Read our terms and conditions for using our developer tools.",
    url: "/terms",
    keywords: [
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 space-y-12">
          ...
          <Card className="glass border-0 max-w-4xl mx-auto">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                ...
                processing happens in your browser, and we do not collect or
                store your data.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <div>
                  ...
                  <ul className="space-y-2 list-disc list-inside">
                    ...
                    <li>
                      Attempt to interfere with or disrupt our services or
                      servers
                    </li>
                    <li>
            ...
            <Card className="glass border-0">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  ...
                  of our services without our explicit written permission.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass border-0">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p className="leading-relaxed">
                  DevConverter is provided "as is" and "as available" without
            ...
            <Card className="glass border-0">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p className="leading-relaxed">
                  Since all processing happens in your browser, we never
                  receive, store, or have access to any content you input into
                  our tools. You retain all rights to your content.
                </p>
                <p className="leading-relaxed">
                  You are solely responsible for the content you process using
                  our tools and for ensuring you have the necessary rights and
            ...
            <Card className="glass border-0 bg-gradient-to-br from-primary/5 to-accent/5">
              <CardContent className="pt-6 text-center space-y-3">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  ...
                  about these terms, please don't hesitate to reach out at
