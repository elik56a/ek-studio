          ...
          <Card className="glass border-0 max-w-4xl mx-auto">
            ...
            <CardContent className="space-y-4 text-center">
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                DevConverter was born from a simple frustration: why do we need
                to upload sensitive data to random servers just to format JSON
                or decode Base64?
              </p>
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                We set out to create a suite of developer tools that respect
                your privacy, work instantly, and are completely free. Every
                tool runs entirely in your browser—your data never touches our
                servers.
              </p>
            </CardContent>
          </Card>
            ...
            <Card className="glass border-0">
              <CardContent className="pt-6 space-y-4 text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  ...
                  fast, private, and did exactly what we needed. We shared it
                  with friends, and they loved it. Soon, requests started coming
                  in for more tools.
                </p>
                <p className="leading-relaxed">
                  Today, DevConverter provides essential developer tools that
                  run entirely in your browser—all without ever storing a single
                  byte of user data. We're committed to being a privacy-first
