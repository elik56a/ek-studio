...
export function Dropdown({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className={`absolute top-full ${variant === "hover" ? "pt-1" : "mt-2"} ${alignmentClasses[align]} z-[100]`}
        >
          <div
...
export function DropdownHeader({
  ...
  return (
    <div
      className={`px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider ${className}`}
    >
      {children}
    </div>
  )
