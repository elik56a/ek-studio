    ...
    <section className="space-y-12 px-4">
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-base sm:text-lg text-muted-foreground">
          Whether you're debugging APIs, encoding data, or validating tokens,
          our developer tools help you work faster. No installation needed—just
          open your browser and start using professional-grade tools instantly.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pb-4">
          <Card className="glass border-0 text-center py-8 px-6 hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              ...
              waiting. Handle large files and complex operations without
              breaking a sweat.
            </p>
          </Card>
          ...
          <Card className="glass border-0 text-center py-8 px-6 hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              ...
              Perfect for handling sensitive information like API keys and
              tokens.
            </p>
          </Card>
          ...
          <Card className="glass border-0 text-center py-8 px-6 hover:shadow-glow transition-all duration-300 hover:-translate-y-1 sm:col-span-2 md:col-span-1">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Keyboard shortcuts, dark mode, syntax highlighting, and features
              developers actually need for maximum efficiency.
            </p>
          </Card>
        </div>
      </div>
