...
export function ToolFooter({
  ...
  return (
    <div className={`space-y-8 ${className}`}>
      {/* Examples Section */}
      {examples.length > 0 && (
        <section id="examples" className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500 scroll-mt-20">
      ...
      {/* FAQ Section */}
      {faqs.length > 0 && (
        <section id="faq" className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150 scroll-mt-20">
          <div className="flex items-center gap-3">
