        ...
        <Card className="glass border-0 shadow-glow flex flex-col">
          ...
          <CardContent className="flex-1 p-3 sm:p-6 pt-3 sm:pt-4">
            <Textarea
              ...
              className="w-full h-full min-h-[200px] max-h-[300px] resize-y font-mono text-xs sm:text-sm bg-background/50 border-border/50 focus:bg-background focus:border-primary/50 transition-all duration-200"
            />
          </CardContent>
        </Card>
